...
export type SettlementProcessingRunRow = {
  ...
  stage_sha256: string | null;
  stage_size_bytes: number | null;
  stage_file_count: number | null;
  stage_raw_row_count: number | null;
  stage_sales_row_count: number | null;
  stage_ready_at: string | null;
  workbook_sha256: string | null;
  workbook_archive_sha256: string | null;
  workbook_size_bytes: number | null;
  workbook_sheet_count: number | null;
  workbook_row_count: number | null;
  office_verifier: string | null;
  office_version: string | null;
  office_archive_sha256: string | null;
  office_sheet_count: number | null;
  office_row_count: number | null;
  workbook_ready_at: string | null;
  error_summary: string | null;
  claimed_at: string;
